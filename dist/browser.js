...
return function(t){return e.apply(this,arguments)}}()},{key:"custodialMigrateAccount",value:function(){var e=a()(o.a.mark(function e(t){var r,n,i,a,s,c,u,f,l,p,d,y,v,g,m
return o.a.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(r=this.options,n=r.apiKey,i=r.oreIdUrl,a=r.serviceKey){e.next=3
break}throw new Error("Missing serviceKey in oreId config options - required to call api/custodial/migrate-account.")
case 3:return s=t.account,c=t.chainAccount,u=t.chainNetwork,f=t.toType,l=t.userPassword,p={account:s,chain_account:c,chain_network:u,to_type:f,user_password:l},d="".concat(i,"/api/custodial/migrate-account"),e.next=8,h.a.post(d,JSON.stringify(p),{headers:{"Content-Type":"application/json","api-key":n,"service-key":a},body:p})
...
break}u=s.auth,f=u.accountName,l=u.permission,h=u.publicKey,c={isLoggedIn:!0,account:f,permissions:[{name:l,publicKey:h}],provider:t,transitWallet:s},e.next=25
break
