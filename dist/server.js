...
return o}function T(e,t,r,n){null==t?e.push(0):(e.push(1),this.optionalOf.serialize(e,t,r,n))}function P(e,t,r){return e.get()?this.optionalOf.deserialize(e,t,r):null}function I(e,t,r,n){this.extensionOf.serialize(e,t,r,n)}function N(e,t,r){return this.extensionOf.deserialize(e,t,r)}function U(e){return n({name:"<missing name>",aliasOfName:"",arrayOf:null,optionalOf:null,extensionOf:null,baseName:"",base:null,fields:[],serialize:x,deserialize:_},e)}function R(e,t){if(Number.isNaN(+e)||Number.isNaN(+t)||"number"!=typeof e&&"string"!=typeof e)throw new Error("Expected number")
...
if(r)return r
if(t.endsWith("[]"))return U({name:t,arrayOf:z(e,t.substr(0,t.length-2)),serialize:S,deserialize:O})
if(t.endsWith("?"))return U({name:t,optionalOf:z(e,t.substr(0,t.length-1)),serialize:T,deserialize:P})
if(t.endsWith("$"))return U({name:t,extensionOf:z(e,t.substr(0,t.length-1)),serialize:I,deserialize:N})
...
return a.serialize(s,n),b(s.asUint8Array())}function j(e,t,r,n,o,i){var a=e.actions.get(r)
if("string"==typeof n&&(n=w(n)),!a)throw new Error("Unknown action "+r+" in contract "+t)
var s=new u({textDecoder:i,textEncoder:o})
return s.pushArray(n),a.deserialize(s)}t.SerialBuffer=u,t.supportedAbiVersion=function(e){return e.startsWith("eosio::abi/1.")},t.dateToTimePoint=l,t.timePointToDate=p,t.dateToTimePointSec=h,t.timePointSecToDate=d,t.dateToBlockTimestamp=y,t.blockTimestampToDate=v,t.stringToSymbol=g,t.symbolToString=m,t.arrayToHex=b,t.hexToUint8Array=w,t.createInitialTypes=function(){var e=new Map(Object.entries({bool:U({name:"bool",serialize:function(e,t){if("boolean"!=typeof t)throw new Error("Expected true or false")
e.push(t?1:0)},deserialize:function(e){return!!e.get()}}),uint8:U({name:"uint8",serialize:function(e,t){e.push(R(t,255&t))},deserialize:function(e){return e.get()}}),int8:U({name:"int8",serialize:function(e,t){e.push(R(t,t<<24>>24))},deserialize:function(e){return e.get()<<24>>24}}),uint16:U({name:"uint16",serialize:function(e,t){e.pushUint16(R(t,65535&t))},deserialize:function(e){return e.getUint16()}}),int16:U({name:"int16",serialize:function(e,t){e.pushUint16(R(t,t<<16>>16))},deserialize:function(e){return e.getUint16()<<16>>16}}),uint32:U({name:"uint32",serialize:function(e,t){e.pushUint32(R(t,t>>>0))},deserialize:function(e){return e.getUint32()}}),uint64:U({name:"uint64",serialize:function(e,t){e.pushArray(s.decimalToBinary(8,""+t))},deserialize:function(e){return s.binaryToDecimal(e.getUint8Array(8))}}),int64:U({name:"int64",serialize:function(e,t){e.pushArray(s.signedDecimalToBinary(8,""+t))},deserialize:function(e){return s.signedBinaryToDecimal(e.getUint8Array(8))}}),int32:U({name:"int32",serialize:function(e,t){e.pushUint32(R(t,0|t))},deserialize:function(e){return 0|e.getUint32()}}),varuint32:U({name:"varuint32",serialize:function(e,t){e.pushVaruint32(R(t,t>>>0))},deserialize:function(e){return e.getVaruint32()}}),varint32:U({name:"varint32",serialize:function(e,t){e.pushVarint32(R(t,0|t))},deserialize:function(e){return e.getVarint32()}}),uint128:U({name:"uint128",serialize:function(e,t){e.pushArray(s.decimalToBinary(16,""+t))},deserialize:function(e){return s.binaryToDecimal(e.getUint8Array(16))}}),int128:U({name:"int128",serialize:function(e,t){e.pushArray(s.signedDecimalToBinary(16,""+t))},deserialize:function(e){return s.signedBinaryToDecimal(e.getUint8Array(16))}}),float32:U({name:"float32",serialize:function(e,t){e.pushFloat32(t)},deserialize:function(e){return e.getFloat32()}}),float64:U({name:"float64",serialize:function(e,t){e.pushFloat64(t)},deserialize:function(e){return e.getFloat64()}}),float128:U({name:"float128",serialize:function(e,t){e.pushUint8ArrayChecked(w(t),16)},deserialize:function(e){return b(e.getUint8Array(16))}}),bytes:U({name:"bytes",serialize:function(e,t){t instanceof Uint8Array||Array.isArray(t)?e.pushBytes(t):e.pushBytes(w(t))},deserialize:function(e,t){return t&&t.options.bytesAsUint8Array?e.getBytes():b(e.getBytes())}}),string:U({name:"string",serialize:function(e,t){e.pushString(t)},deserialize:function(e){return e.getString()}}),name:U({name:"name",serialize:function(e,t){e.pushName(t)},deserialize:function(e){return e.getName()}}),time_point:U({name:"time_point",serialize:function(e,t){e.pushNumberAsUint64(l(t))},deserialize:function(e){return p(e.getUint64AsNumber())}}),time_point_sec:U({name:"time_point_sec",serialize:function(e,t){e.pushUint32(h(t))},deserialize:function(e){return d(e.getUint32())}}),block_timestamp_type:U({name:"block_timestamp_type",serialize:function(e,t){e.pushUint32(y(t))},deserialize:function(e){return v(e.getUint32())}}),symbol_code:U({name:"symbol_code",serialize:function(e,t){e.pushSymbolCode(t)},deserialize:function(e){return e.getSymbolCode()}}),symbol:U({name:"symbol",serialize:function(e,t){e.pushSymbol(g(t))},deserialize:function(e){return m(e.getSymbol())}}),asset:U({name:"asset",serialize:function(e,t){e.pushAsset(t)},deserialize:function(e){return e.getAsset()}}),checksum160:U({name:"checksum160",serialize:function(e,t){e.pushUint8ArrayChecked(w(t),20)},deserialize:function(e){return b(e.getUint8Array(20))}}),checksum256:U({name:"checksum256",serialize:function(e,t){e.pushUint8ArrayChecked(w(t),32)},deserialize:function(e){return b(e.getUint8Array(32))}}),checksum512:U({name:"checksum512",serialize:function(e,t){e.pushUint8ArrayChecked(w(t),64)},deserialize:function(e){return b(e.getUint8Array(64))}}),public_key:U({name:"public_key",serialize:function(e,t){e.pushPublicKey(t)},deserialize:function(e){return e.getPublicKey()}}),private_key:U({name:"private_key",serialize:function(e,t){e.pushPrivateKey(t)},deserialize:function(e){return e.getPrivateKey()}}),signature:U({name:"signature",serialize:function(e,t){e.pushSignature(t)},deserialize:function(e){return e.getSignature()}})}))
return e.set("extended_asset",U({name:"extended_asset",baseName:"",fields:[{name:"quantity",typeName:"asset",type:e.get("asset")},{name:"contract",typeName:"name",type:e.get("name")}],serialize:k,deserialize:C})),e},t.getType=z,t.getTypesFromAbi=function(e,t){var r,n,i,s,c,u,f,l,p,h,d=new Map(e)
if(t.types)try{for(var y=a(t.types),v=y.next();!v.done;v=y.next()){var g=v.value,m=g.new_type_name,b=g.type
d.set(m,U({name:m,aliasOfName:b}))}}catch(e){r={error:e}}finally{try{v&&!v.done&&(n=y.return)&&n.call(y)}finally{if(r)throw r.error}}if(t.structs)try{for(var w=a(t.structs),x=w.next();!x.done;x=w.next()){var _=x.value,S=_.name,O=_.base,T=_.fields
d.set(S,U({name:S,baseName:O,fields:T.map(function(e){return{name:e.name,typeName:e.type,type:null}}),serialize:k,deserialize:C}))}}catch(e){i={error:e}}finally{try{x&&!x.done&&(s=w.return)&&s.call(w)}finally{if(i)throw i.error}}if(t.variants)try{for(var P=a(t.variants),I=P.next();!I.done;I=P.next()){var N=I.value,R=N.name,B=N.types
d.set(R,U({name:R,fields:B.map(function(e){return{name:e,typeName:e,type:null}}),serialize:A,deserialize:E}))}}catch(e){c={error:e}}finally{try{I&&!I.done&&(u=P.return)&&u.call(P)}finally{if(c)throw c.error}}try{for(var j=a(d),F=j.next();!F.done;F=j.next()){var L=o(F.value,2)
L[0],(b=L[1]).baseName&&(b.base=z(d,b.baseName))
try{for(var D=a(b.fields),q=D.next();!q.done;q=D.next()){var M=q.value
M.type=z(d,M.typeName)}}catch(e){p={error:e}}finally{try{q&&!q.done&&(h=D.return)&&h.call(D)}finally{if(p)throw p.error}}}}catch(e){f={error:e}}finally{try{F&&!F.done&&(l=j.return)&&l.call(j)}finally{if(f)throw f.error}}return d},t.transactionHeader=function(e,t){return{expiration:d(h(e.timestamp)+t),ref_block_num:65535&e.block_num,ref_block_prefix:e.ref_block_prefix}},t.serializeActionData=B,t.serializeAction=function(e,t,r,n,o,i,a){return{account:t,name:r,authorization:n,data:B(e,t,r,o,i,a)}},t.deserializeActionData=j,t.deserializeAction=function(e,t,r,n,o,i,a){return{account:t,name:r,authorization:n,data:j(e,t,r,o,i,a)}}},function(e,t,r){"use strict"
...
if(I){var N=f.parse(I),U=process.env.no_proxy||process.env.NO_PROXY,R=!0
if(U)R=!U.split(",").map(function(e){return e.trim()}).some(function(e){return!!e&&("*"===e||("."===e[0]&&_.hostname.substr(_.hostname.length-e.length)===e&&e.match(/\./g).length===_.hostname.match(/\./g).length||_.hostname===e))})
if(R&&(T={host:N.hostname,port:N.port},N.auth)){var z=N.auth.split(":")
T.auth={username:z[0],password:z[1]}}}}if(T&&(S.hostname=T.host,S.host=T.host,S.headers.host=_.hostname+(_.port?":"+_.port:""),S.port=T.port,S.path=k+"//"+_.hostname+(_.port?":"+_.port:"")+S.path,T.auth)){var B=Buffer.from(T.auth.username+":"+T.auth.password,"utf8").toString("base64")
S.headers["Proxy-Authorization"]="Basic "+B}var j=A&&(!T||y.test(T.protocol))
e.transport?O=e.transport:0===e.maxRedirects?O=j?s:a:(e.maxRedirects&&(S.maxRedirects=e.maxRedirects),O=j?u:c),e.maxContentLength&&e.maxContentLength>-1&&(S.maxBodyLength=e.maxContentLength)
...
return d}var S=r(12),O=r.n(S),T=r(28),P=r.n(T),I=r(71).Base64,N=function(e,t,r){return e.replace(new RegExp(t,"g"),r)},U=function(){function e(){f()(this,e)}return p()(e,null,[{key:"isNullOrEmpty",value:function(e){return void 0===e||(null===e||(!(!Array.isArray(e)||0!==e.length)||0===Object.keys(e).length&&e.constructor===Object))}},{key:"log",value:function(e,t){0}},{key:"jwtDecodeSafe",value:function(e){var t={}
...
if(!r)return null
var n=""
try{t&&(r=decodeURI(r)),n=N(r,"'",'"'),n=N(n,"`",'"')
var o=JSON.parse(n)
...
return Object.getOwnPropertySymbols&&r.push.apply(r,Object.getOwnPropertySymbols(e)),t&&(r=r.filter(function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable})),r}var j=function(){function e(){f()(this,e)}return p()(e,[{key:"getItem",value:function(e){return z.a.get(e)}},{key:"removeItem",value:function(e){z.a.remove(e)}},{key:"setItem",value:function(e,t,r){var n=function(e){for(var t=1;t<arguments.length;t++){var r=null!=arguments[t]?arguments[t]:{}
t%2?B(r,!0).forEach(function(t){o()(e,t,r[t])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(r)):B(r).forEach(function(t){Object.defineProperty(e,t,Object.getOwnPropertyDescriptor(r,t))})}return e}({expires:1},r)
z.a.set(e,t,n)}}]),e}(),F=function(){function e(){f()(this,e),window?this.storage=window.localStorage:U.log("Not running in Browser. Using CookieStorage instead.")}return p()(e,[{key:"getItem",value:function(e){if(this.storage)return this.storage.getItem(e)}},{key:"removeItem",value:function(e){if(this.storage)return this.storage.removeItem(e)}},{key:"setItem",value:function(e,t,r){if(this.storage)return this.storage.setItem(e,t,r)}}]),e}(),L=function(){function e(){f()(this,e)}return p()(e,[{key:"getItem",value:function(e){return null}},{key:"removeItem",value:function(e){}},{key:"setItem",value:function(e,t,r){}}]),e}(),D=function(){function e(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{tryLocalStorageFirst:!0}
if(f()(this,e),this.triedLocalStorage=!1,this.triedCookieStorage=!1,!0===t.tryLocalStorageFirst){this.triedLocalStorage=!0
try{var r=new F
r&&r.storage&&(this.storage=r)}catch(e){U.log("Can't use localStorage. Using CookieStorage instead.",t)}}this.storage||(this.storage=new j,this.triedCookieStorage=!0)}return p()(e,[{key:"failover",value:function(){if(!(this.storage instanceof L)){var e=!1
this.storage instanceof F?this.triedCookieStorage||(this.storage=new j,this.triedCookieStorage=!0,e=!0):this.storage instanceof j&&(this.triedLocalStorage||(this.storage=new F,this.triedLocalStorage=!0,e=!0)),e||(this.storage=new L)}}},{key:"getItem",value:function(e){try{return this.storage.getItem(e)}catch(t){return U.log("Can't getItem in storage.",t),this.failover(),this.storage.getItem(e)}}},{key:"removeItem",value:function(e){try{return this.storage.removeItem(e)}catch(t){return U.log("Can't removeItem in storage.",t),this.failover(),this.storage.removeItem(e)}}},{key:"setItem",value:function(e,t,r){try{return this.storage.setItem(e,t,r)}catch(n){return U.log("Can't setItem in storage.",n),this.failover(),this.storage.setItem(e,t,r)}}}]),e}(),q={ledger:{providerId:"ledger",requiresLogin:!1,supportsDiscovery:!0,supportsSignArbitrary:!1,helpText:{login:"This wallet doesn’t require you to login",sign:"Connect and unlock your Ledger with your PIN code. Launch the EOS app on the device.",discover:"Connect and unlock your Ledger with your PIN code. Launch the EOS app on the device.",versionsRequired:"You need to have recent versions of your browser, Ledger firmware, and the Ledger EOS app. Click here for more details."}},lynx:{providerId:"EOS Lynx",requiresLogin:!0,supportsDiscovery:!1,supportsSignArbitrary:!0,helpText:{login:"EOS Lynx requires logging in through the EOS Lynx app.",sign:"",discover:"",versionsRequired:""}},meetone:{providerId:"meetone_provider",requiresLogin:!1,supportsDiscovery:!1,supportsSignArbitrary:!0,helpText:{login:"This wallet doesn’t require you to login",sign:"",discover:"",versionsRequired:""}},metro:{providerId:"metro",requiresLogin:!1,supportsDiscovery:!1,supportsSignArbitrary:!1,helpText:{login:"This wallet doesn’t require you to login",sign:"",discover:"",versionsRequired:""}},scatter:{providerId:"scatter",requiresLogin:!0,supportsDiscovery:!1,supportsSignArbitrary:!0,helpText:{login:"Scatter requires logging in through the Scatter app.",sign:"",discover:"",versionsRequired:""}},tokenpocket:{providerId:"TokenPocket",requiresLogin:!0,supportsDiscovery:!1,supportsSignArbitrary:!0,helpText:{login:"This wallet doesn’t require you to login",sign:"",discover:"",versionsRequired:""}},portis:{providerId:"PortisProvider",requiresLogin:!0,supportsDiscovery:!1,supportsSignArbitrary:!1,helpText:{login:"Portis requires logging in through the Portis app.",sign:"",discover:"",versionsRequired:""}},whalevault:{providerId:"whalevault",requiresLogin:!0,supportsDiscovery:!1,supportsSignArbitrary:!0,helpText:{login:"Whalevault requires logging in through the Whalevault app.",sign:"",discover:"",versionsRequired:""}},simpleos:{providerId:"simpleos",requiresLogin:!0,supportsDiscovery:!1,supportsSignArbitrary:!1,helpText:{login:"Simpleos requires logging in through the Simpleos app.",sign:"",discover:"",versionsRequired:""}},keycat:{providerId:"Keycat",requiresLogin:!0,supportsDiscovery:!1,supportsSignArbitrary:!0,helpText:{login:"Keycat requires logging in through the Keycat app.",sign:"",discover:"",versionsRequired:""}}},M={scatter:{requiresLogin:!0,supportsSignArbitrary:!0,helpText:{login:"Scatter requires logging in through the Scatter app.",sign:"",discover:"",versionsRequired:""}},ledger:{requiresLogin:!0,supportsSignArbitrary:!1,helpText:{login:"This wallet doesn’t require you to login",sign:"Connect and unlock your Ledger with your PIN code. Launch the EOS app on the device.",discover:"Connect and unlock your Ledger with your PIN code. Launch the EOS app on the device.",versionsRequired:"You need to have recent versions of your browser, Ledger firmware, and the Ledger EOS app. Click here for more details."}},lynx:{requiresLogin:!1,supportsSignArbitrary:!0,helpText:{login:"This wallet doesn’t require you to login",sign:"",discover:"",versionsRequired:""}},meetone:{requiresLogin:!1,supportsSignArbitrary:!0,helpText:{login:"This wallet doesn’t require you to login",sign:"",discover:"",versionsRequired:""}},tokenpocket:{requiresLogin:!1,supportsSignArbitrary:!0,helpText:{login:"This wallet doesn’t require you to login",sign:"",discover:"",versionsRequired:""}}},K=["metro"],W=Object.keys(q),V=Object.keys(M)
function J(e,t){var r=Object.keys(e)
return Object.getOwnPropertySymbols&&r.push.apply(r,Object.getOwnPropertySymbols(e)),t&&(r=r.filter(function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable})),r}function G(e){for(var t=1;t<arguments.length;t++){var r=null!=arguments[t]?arguments[t]:{}
t%2?J(r,!0).forEach(function(t){o()(e,t,r[t])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(r)):J(r).forEach(function(t){Object.defineProperty(e,t,Object.getOwnPropertyDescriptor(r,t))})}return e}var H="custodial",Y="ual",$="transit",Z=function(){function e(t){f()(this,e),this.options=null,this.appAccessToken=null,this.user=null,this.storage=new D,this.chainContexts={},this.cachedChainNetworks=null,this.validateOptions(t),this.validateProviders()}var t,r,n,o,i,s,u,l,h,y,v,g,m,b,w,x,_,k,C,A,S,O,T,P,I,N,R,z,B,j,F,L,J,Z,X,Q,ee,te,re,ne,oe,ie,ae,se
return p()(e,[{key:"validateProviders",value:(se=c()(a.a.mark(function e(){var t,r,n,o,i
return a.a.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(t=U.isNullOrEmpty,r=this.options,n=r.ualProviders,o=r.eosTransitWalletProviders,t(o)||t(n)){e.next=6
...
case 6:case"end":return e.stop()}},e,this)})),function(){return se.apply(this,arguments)})},{key:"chainNetworks",value:(ae=c()(a.a.mark(function e(){var t
...
case 6:case"end":return e.stop()}},e,this)})),function(){return ae.apply(this,arguments)})},{key:"getNetworkConfig",value:(ie=c()(a.a.mark(function e(t){var r,n,o,i,s,c,u,f
...
case 9:case"end":return e.stop()}},e,this)})),function(e){return ie.apply(this,arguments)})},{key:"getOrCreateChainContext",value:(oe=c()(a.a.mark(function e(t){var r,n,o,i,s,c
...
case 9:case"end":return e.stop()}},e,this)})),function(e){return oe.apply(this,arguments)})},{key:"callPasswordlessApi",value:(ne=c()(a.a.mark(function e(t){var r,n,o,i,s,c,u,f,l,p,h,y,v=arguments
...
case 22:case"end":return e.stop()}},e,this,[[12,18]])})),function(e){return ne.apply(this,arguments)})},{key:"passwordlessSendCodeApi",value:(re=c()(a.a.mark(function e(t){var r
...
case 11:case"end":return e.stop()}},e,this,[[1,7]])})),function(e){return re.apply(this,arguments)})},{key:"passwordlessVerifyCodeApi",value:(te=c()(a.a.mark(function e(t){var r
return a.a.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return r={},e.prev=1,e.next=4,this.callPasswordlessApi(t,!0)
case 4:r=e.sent,e.next=10
break
case 7:return e.prev=7,e.t0=e.catch(1),e.abrupt("return",{error:e.t0})
case 10:return e.abrupt("return",r)
case 11:case"end":return e.stop()}},e,this,[[1,7]])})),function(e){return te.apply(this,arguments)})},{key:"login",value:(ee=c()(a.a.mark(function e(t){var r
return a.a.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(r=t.provider,!K.includes(r)){e.next=3
break}throw new Error("Not Implemented")
case 3:if(!W.includes(r)&&!V.includes(r)){e.next=5
break}return e.abrupt("return",this.loginWithNonOreIdProvider(t))
case 5:return e.abrupt("return",this.loginWithOreId(t))
case 6:case"end":return e.stop()}},e,this)})),function(e){return ee.apply(this,arguments)})},{key:"sign",value:(Q=c()(a.a.mark(function e(t){var r
return a.a.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(r=t.provider,!K.includes(r)){e.next=3
break}return e.abrupt("return")
case 3:if(!this.isCustodial(r)){e.next=5
break}return e.abrupt("return",this.custodialSignWithOreId(t))
case 5:if(!W.includes(r)&&!V.includes(r)){e.next=7
break}return e.abrupt("return",this.signWithNonOreIdProvider(t))
case 7:return e.abrupt("return",this.signWithOreId(t))
case 8:case"end":return e.stop()}},e,this)})),function(e){return Q.apply(this,arguments)})},{key:"discover",value:(X=c()(a.a.mark(function e(t){var r,n,o,i
...
case 5:case"end":return e.stop()}},e,this)})),function(e){return X.apply(this,arguments)})},{key:"assertValidProvider",value:function(e){if(q[e])return!0
throw new Error("Provider ".concat(e," is not a valid option"))}},{key:"canDiscover",value:function(e){return!this.isUALProvider(e)&&!0===q[e].supportsDiscovery}},{key:"loginWithOreId",value:(Z=c()(a.a.mark(function e(t){var r,n,o,i,s,c,u,f,l,p
...
case 7:case"end":return e.stop()}},e,this)})),function(e){return Z.apply(this,arguments)})},{key:"signWithOreId",value:(J=c()(a.a.mark(function e(t){var r,n
...
case 6:case"end":return e.stop()}},e,this)})),function(e){return J.apply(this,arguments)})},{key:"custodialSignWithOreId",value:(L=c()(a.a.mark(function e(t){var r,n,o,i,s,c,u,f,l,p,h,y,v,g,m,b,w,x,_,k
...
case 16:case"end":return e.stop()}},e,this)})),function(e){return L.apply(this,arguments)})},{key:"signString",value:(F=c()(a.a.mark(function e(t){var r
...
case 4:case"end":return e.stop()}},e,this)})),function(e){return F.apply(this,arguments)})},{key:"canSignString",value:function(e){return!(!W.includes(e)&&!V.includes(e))&&(this.isUALProvider(e)?M[e].supportsSignArbitrary:q[e].supportsSignArbitrary)}},{key:"signArbitraryWithUALProvider",value:(j=c()(a.a.mark(function e(t){var r,n,o,i,s,c,u,f,l
...
case 23:case"end":return e.stop()}},e,this,[[5,16,20,23]])})),function(e){return j.apply(this,arguments)})},{key:"signArbitraryWithTransitProvider",value:(B=c()(a.a.mark(function e(t){var r,n,o,i,s,c,u
...
case 20:case"end":return e.stop()}},e,this,[[5,13,17,20]])})),function(e){return B.apply(this,arguments)})},{key:"signWithNonOreIdProvider",value:(z=c()(a.a.mark(function e(t){var r
...
case 13:throw e.prev=13,e.t0=e.catch(5),console.error(e.t0),e.t0
case 17:return e.prev=17,this.setIsBusy(!1),e.finish(17)
case 20:case"end":return e.stop()}},e,this,[[5,13,17,20]])})),function(e){return R.apply(this,arguments)})},{key:"signWithTransitProvider",value:(N=c()(a.a.mark(function e(t){var r,n,o,i,s,c
...
case 19:case"end":return e.stop()}},e,this,[[5,12,15,18]])})),function(e){return N.apply(this,arguments)})},{key:"custodialNewAccount",value:(I=c()(a.a.mark(function e(t){var r,n,o,i,s,c,u,f,l,p,h,y,v,g,m
...
case 14:throw e.t0
case 15:case"end":return e.stop()}},e,null,[[0,7]])})),function(e,t,r){return O.apply(this,arguments)})},{key:"connectToUALProvider",value:(S=c()(a.a.mark(function e(t){var r,n,o,i,s,c,u,f,l,p,h,d,y,v
...
case 6:return u=e.sent,f={chainId:u.chainId,rpcEndpoints:[G({},u)]},l=new c([f],{appName:this.options.appName}),e.next=11,l.init()
case 11:return e.next=13,this.loginToUALProvider(l,o,s)
case 13:if(p=e.sent,U.isNullOrEmpty(p)){e.next=26
...
case 35:case"end":return e.stop()}},e,this,[[3,28]])})),function(e){return S.apply(this,arguments)})},{key:"loginToTransitProvider",value:(A=c()(a.a.mark(function e(t,r,n){var o
...
case 17:case"end":return e.stop()}},e,this,[[0,5,13,17]])})),function(e,t,r){return A.apply(this,arguments)})},{key:"connectToTransitProvider",value:(C=c()(a.a.mark(function e(t){var r,n,o,i,s,c,u,f,l,p,h,d,y,v,g,m
return a.a.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return r=t.provider,n=t.chainNetwork,o=void 0===n?"eos_main":n,i=q[r].providerId,e.next=4,this.getOrCreateChainContext(o)
case 4:return s=e.sent,c=s.getWalletProviders().find(function(e){return e.id===i}),u=s.initWallet(c),f={transitWallet:u},e.prev=8,e.next=11,u.connect()
case 11:return e.next=13,this.waitWhileWalletIsBusy(u,r)
case 13:if(!q[r].requiresLogin){e.next=21
break}if(!u||u.authenticated){e.next=19
break}return e.next=17,this.loginToTransitProvider(u,r,o)
case 17:e.next=21
break
case 19:if(u&&u.authenticated){e.next=21
break}throw new Error("Couldn't connect to ".concat(r))
case 21:if(!u.connected){e.next=25
break}u.authenticated&&(l=u.auth,p=l.accountName,h=l.permission,d=l.publicKey,f={isLoggedIn:!0,account:p,permissions:[{name:h,publicKey:d}],provider:r,transitWallet:u}),e.next=29
break
case 25:throw y=u.hasError,v=u.errorMessage,g="".concat(r," not connected!"),y&&(g+=" Error: ".concat(v)),new Error(g)
case 29:if(!u.eosApi){e.next=33
break}return m=u.eosApi.chainId,e.next=33,this.updatePermissionsIfNecessary(f,m,r)
case 33:e.next=39
break
...
case 42:return e.abrupt("return",f)
...
return a.a.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,this.chainNetworks()
case 2:if(r=e.sent,n=r.find(function(e){return e.hosts.find(function(e){return e.chainId===t})}),U.isNullOrEmpty(n)){e.next=6
...
case 4:if(n=e.sent,o=n.find(function(e){return e.hosts.find(function(e){return e.chainId===r})}),U.isNullOrEmpty(o)){e.next=8
...
return a.a.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(!(U.isNullOrEmpty(o)||U.isNullOrEmpty(n)||U.isNullOrEmpty(r))){e.next=2
break}return e.abrupt("return")
...
case 8:return d=e.sent,y=U.base64Encode(f),v=u?"&state=".concat(u):"",v+=U.isNullOrEmpty(n)?"":"&allow_chain_account_selection=".concat(n),v+=U.isNullOrEmpty(c)?"":"&return_signed_transaction=".concat(c),v+=U.isNullOrEmpty(l)?"":"&user_password=".concat(l),e.abrupt("return","".concat(h,"/sign#app_access_token=").concat(d,"&account=").concat(r,"&broadcast=").concat(o,"&callback_url=").concat(encodeURIComponent(i),"&chain_account=").concat(p,"&chain_network=").concat(encodeURIComponent(s),"&transaction=").concat(y).concat(v))
case 15:case"end":return e.stop()}},e,this)})),function(e){return l.apply(this,arguments)})},{key:"handleAuthResponse",value:function(e){var t=U.urlParamsToArray(e),r=t.accessToken,n=t.account,o=t.idToken,i=t.state,a=this.getErrorCodesFromParams(t),s={account:n}
...
return a||(t=U.base64DecodeSafe(n)),this.setIsBusy(!1),{signedTransaction:t,state:o,transactionId:i,errors:a}}},{key:"getNewAppAccessToken",value:(u=c()(a.a.mark(function e(){var t,r
...
return U.isNullOrEmpty(e)?(this.user=null,null):(this.user=JSON.parse(e),this.user)}},{key:"clearLocalState",value:(t=c()(a.a.mark(function e(){return a.a.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:this.storage.removeItem(this.userKey())
case 1:case"end":return e.stop()}},e,this)})),function(){return t.apply(this,arguments)})},{key:"isCustodial",value:function(e){return e===H}},{key:"isUALProvider",value:function(e){var t=this.options.ualProviders
return t&&t.find(function(t){return t.name.toLowerCase()===e.toLowerCase()})}},{key:"getWalletProviderInfo",value:function(e,t){return e&&t?t.toLowerCase()===$?q[e]:t.toLowerCase()===Y?M[e]:void 0:{ualProviderAttributes:M,transitProviderAttributes:q}}}]),e}(),X=function(e){return function(t,r,n){Promise.resolve(e(t,r,n)).catch(n)}}
function Q(e){return X(function(){var t=c()(a.a.mark(function t(r,n,o){var i,s,c,u,f,l,p,h
...
return function(e,r,n){return t.apply(this,arguments)}}())}function ee(e){return X(function(){var t=c()(a.a.mark(function t(r,n,o){var i,s,c,u,f,l,p
...
return function(e,r,n){return t.apply(this,arguments)}}())}r.d(t,"asyncHandler",function(){return X}),r.d(t,"authCallbackHandler",function(){return Q}),r.d(t,"OreId",function(){return Z}),r.d(t,"signCallbackHandler",function(){return ee})}])})
