...
case 5:return l="send",r&&(l="verify"),p="".concat(f,"/api/account/login-passwordless-").concat(l,"-code?login-type=").concat(n),a&&(p+="&email=".concat(a)),i&&(p+="&phone=".concat(i)),r&&(p+="&code=".concat(s)),d={},e.prev=12,e.next=15,h.a.get(p,{headers:{"api-key":u}})
