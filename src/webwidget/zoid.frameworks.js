!function(root, factory) {
    ...
    return function(modules) {
        ...
        var react = {
            register: function(tag, propsDef, init, _ref, context) {
        ...
        function component(opts) {
            ...
            return {
                ...
                driver: function(driverName, dep) {
                    ...
                    driverCache[driverName] || (driverCache[driverName] = drivers[driverName].register(tag, propsDef, init, dep, defaultContext));
